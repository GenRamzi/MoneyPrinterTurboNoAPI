...
TEMPLATES: tuple[SubtitleTemplate, ...] = (
    ...
    SubtitleTemplate(
        "breaking-news",
        "Breaking News",
        "Urgent red-and-white headline captions for breaking-news reels.",
        "ass",
        "top",
        "Arial",
        30,
    ...
    SubtitleTemplate(
        "education-focus",
        "Education Focus",
        "Calm cyan captions with a deep-blue outline for lessons and explainers.",
        "ass",
        "bottom",
        "Arial",
        25,
    ...
    SubtitleTemplate(
        "education-highlight",
        "Education Highlight",
        "Warm yellow emphasis for definitions, formulas, and key takeaways.",
        "ass",
        "center",
        "Arial",
        29,
